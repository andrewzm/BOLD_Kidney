function [h,im_matched, theta,xshift,yshift,I,J]=im_reg_MI(image1, image2, angle, step,usegradient);
...
% Edited by Andrew Zammit-Mangion
image1orig = image1;
image2orig = image2;

if usegradient == 'T'
   image1 = abs(gradient(image1));
   image2 = abs(gradient(image2));
end
...
xshift = I;
yshift = J;
im_rot = rotate_image(theta,image2orig);
